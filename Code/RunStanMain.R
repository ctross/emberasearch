...
'                                                                                                                       
 ...
 m1 <- stan( model_code=model_code_1, data=model_dat,refresh=refresh,chains=nchains,seed=seed,control=list(adapt_delta=ad, max_treedepth=mtd),iter=iter,warmup=warmup)
